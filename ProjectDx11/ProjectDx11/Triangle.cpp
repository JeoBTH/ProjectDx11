...
void Triangle::rotateAlongY(float rate)
{
...
void Triangle::loadTexture(Renderer& renderer)
{
	// Load the texture
...
void Triangle::update(Renderer& renderer)
{
	rotateAlongY(1.0f);
...
void Triangle::createConstantBuffer(Renderer& renderer)
{
